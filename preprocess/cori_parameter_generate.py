...
for data_idx in range(0,200):
    ...
    outputname=StringIO("/gpfs/alpine/med106/world-shared/xf9/aapm-parameters/dcm_%03d/detector1/geom_recon.txt" % data_idx)
    ...
    with open(outputname.getvalue(),'w') as f:
        ...
        sino_DIR="/global/cscratch1/sd/wang1698/AAPM_2022/preprocess/dcm%03d_proj.sino" % (data_idx)        
        f.write(sino_DIR+'\n\n')
        f.write('weight file location\n')
        wght_DIR="/global/cscratch1/sd/wang1698/AAPM_2022/preprocess/dcm%03d_weight.wght" % (data_idx)   
        f.write(wght_DIR+'\n\n')
        ...
        view_DIR="/global/cscratch1/sd/wang1698/AAPM_2022/preprocess/dcm%03d_viewAnglesList.txt" % (data_idx)   
        f.write(view_DIR+'\n\n')
        f.write('source z position list\n')
        z_DIR="/global/cscratch1/sd/wang1698/AAPM_2022/preprocess/dcm%03d_zPositionList.txt" % (data_idx)   
        f.write(z_DIR+'\n')
