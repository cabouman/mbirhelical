...
weight_name="ACR_phantom_726310133_06mm_prior_test"
echo "${weight_name}"
...
recon_directory="/global/cscratch1/sd/wang1698/ACR_phantoms/726310133/06mm_prior_test/recon"
