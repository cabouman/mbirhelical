...
weight_name="ACR_phantom_726310133_2mm_prior_test2"
echo "${weight_name}"
...
recon_directory="/global/cscratch1/sd/wang1698/ACR_phantoms/726310133/2mm_prior_test2/recon"
...
srun -n $NUM_NODES -c 64 --cpu_bind=cores ../src/ct ${forward_model_directory} ${NUM_FOCAL_SPOTS} ${info_recon_directory} ${prior_directory} ${ce_directory} ${recon_directory} 100
