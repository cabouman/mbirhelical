...
weight_name="ACR_phantom_726743491_5mm_prior_test"
echo "${weight_name}"
...
recon_directory="/global/cscratch1/sd/wang1698/ACR_phantoms/726743491/5mm_prior_test/recon"
