...
weight_name="ACR_phantom_726743491_5mm_prior_test2"
echo "${weight_name}"
...
recon_directory="/global/cscratch1/sd/wang1698/ACR_phantoms/726743491/5mm_prior_test2/recon"
