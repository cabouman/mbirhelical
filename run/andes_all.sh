...
do
	...
	srun -N 4 -n 4 -c ${OMP_NUM_THREADS} --cpu_bind=cores ../src/ct ${forward_model_directory} ${NUM_FOCAL_SPOTS} ${info_recon_directory} ${prior_directory} ${ce_directory} ${recon_directory} 50 ${DUAL_ENERGY} ${DEBUG_MODE} ${NUM_SOURCES} &
done
