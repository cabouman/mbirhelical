	...
	/*  Generates normal random numbers: N(0,1)  */
{
	...
	static float   b;      /*   temporary storage                    */
	float a,r,theta,random2();
...
float dexprand()
	/*  Generates a float exponentially distributed random variable
...
int poisson(float lambda)
	/* Generates an int Poisson random variable with mean lambda */
	/* Kruth's algorithm, see Wikipedia */
	/* added by P.J 03/30/2011 */
{
	int k;
	float L, p;
